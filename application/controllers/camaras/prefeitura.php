...
class Prefeitura extends CI_Controller {
    ...
    }			    public function diario( $key) {        $data['publicadas']=$this->db->query('select * from diario_oficial where id_diario_oficial = '.$key)->result();              $this->load->view('transparencia/includes/imports');               $this->load->view('transparencia/arquivo_diario',$data);           }
