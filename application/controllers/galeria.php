...
class Galeria extends CI_Controller {
        ...
        $this->validalogin->valida();
            ...
            if ($this->galeria_model->set($data)) {
                ...
                redirect(site_url('galeria/1'));
            } else {
                redirect(site_url('galeria/6'));
            }
        }
        ...
        $this->validalogin->valida();
            ...
            if ($this->up_multi_img_up($categoria, $key)) {
                ...
                redirect(site_url('galeria/alterarimg/' . $key));
            } else {
                redirect(site_url('galeria/6'));
            }
        }
        ...
        $this->validalogin->valida();
            ...
            if ($this->especialidade_model->update_img($this->input->post('iduser'))) {
                redirect(site_url('especialidade/2'));
            } else {
                echo $this->input->post('iduser');
            }
        }
        ...
        public function getslides(){
            ...
            $query = $this->db->query('select * from slides where local = 2')->result();
