...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form action="<?= base_url(); ?>Vereadores/update"  onsubmit="return validarSenha(this)" enctype="multipart/form-data" method="post">
                    <div class="col-md-12">
                        ...
                        <div class="box-body">
                            ...
                            <select  class="form-control"  name="cargo">
                                <option value="<?php echo $Vereadores[0]->cargo?>" selected><?php echo $Vereadores[0]->cargo?></option>
                                <option value="Presidente">Presidente</option>
                                <option value="Secretario(a)">Secretario</option>
                                <option value="Vereador(a)">Vereador</option>
                    ...
                    <div class=" col-md-12">
                        <br><button type="submit" class="btn btn-primary">Salvar</button> <button type="button" onclick="window.location.href='<?=  base_url('Vereadores')?>'" class="btn btn-danger">Cancelar</button>
                    </div>
                </form>
            </div><!-- /.box-body -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="<?= base_url(); ?>Vereadores/updateimg" enctype="multipart/form-data" method="post">
