...
class publicadas extends CI_Model {
    ...
    public function setpublicacao($obj) {
        if ($this->db->insert('publicacao', $obj)) {
            return $this->db->insert_id();
        }
    }		public function setpublicacaoenvio($obj) {        if ($this->db->insert('envio_arquivo', $obj)) {            return $this->db->insert_id();        }    }
    ...
    public function getPublicacaosuper() {
        ...
        $query = $this->db->query("select * from publicacao");
        return $query->result();
    }
