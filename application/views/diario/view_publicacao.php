    ...
    <section class="content-header">
        <h1>
            <?php foreach ($diario as $row) { ?>
                ...
                ?>  
                Código
                <small>#<?php echo substr($row->id_diario_oficial, -11, 11); ?></small>
            </h1>
            <ol class="breadcrumb">
        ...
        <div class="row invoice-info">
            ...
            </div><!-- /.col -->						 <div class="col-sm-6 invoice-col">                <address>                    <strong>Descrição</strong><br>                    <?= $row->descricao ?>                </address>            </div><!-- /.col -->						<div class="col-sm-6 invoice-col">                <address>                    <strong>Edição</strong><br>                    <?= $row->edicao ?>                </address>            </div><!-- /.col -->
            <div class="col-sm-6 invoice-col">
...
<div class="row no-print" style="float: right;">            <div class="col-xs-12">                <a href="<?php echo $row->file ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Ver arquivo</a>                <a href="<?= site_url('diario') ?>" class="btn btn-primary"><i class="fa "></i> voltar</a>            </div>        </div>
        </div><!-- /.row -->
