<div class="content-wrapper ">
    ...
    <section class="content col-md-8">
        ...
        <div class="box ">
            ...
            <div class="box-body">
                <div class="col-md-12">
                    <form action="<?= site_url(); ?>publicacoes/salvar" enctype="multipart/form-data" method="post">
                        <div class="box-body">
                            ...
                            <div class=" col-md-12">
                                <br><button type="submit" class="btn btn-primary">Enviar</button>       <button  onclick="window.location.href = '<?= site_url() ?>publicacoes'" type="button" value="Cancelar" class="btn btn-danger">Cancelar</button>
                            </div>
                            <!-- tools box -->
