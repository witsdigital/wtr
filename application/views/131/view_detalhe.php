...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            131
            <small>Lançamentos Receita/despesa</small>
        </h1>
        <ol class="breadcrumb">
                    ...
                    <tbody>
                        <?php foreach ($data as $row) { ?>
                            <tr>
                                ...
                                <td align='center' style="width: 180px; "><button onclick="window.location.href = '<?= site_url('Um3Um/visualizar') ?>/<?php echo $row->id ?>/<?php echo $row->arquivo ?>'" class="btn btn-primary btn-flat">Visualizar</button><button onclick="confirma(<?php echo $row->id ?>);" class="btn confirma  btn-danger btn-flat" >Apagar</button></td>
