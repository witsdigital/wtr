...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form action="<?= site_url($this->uri->segment(1)); ?>/salvar"  onsubmit="return validarSenha(this)" enctype="multipart/form-data" method="post">
                    <div class="col-md-12">

                        <div class="box-body">
                            <div class="form-group col-md-4">
                                <label for="exampleInputEmail1">Nome do Evento </label>
                                <input type="text" name="titulo"  class="form-control" required placeholder="Nome do evento">
                            </div>
...
<div class="form-group col-md-4">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="exampleInputFile">Selecionar arquivos</label>
            ...
            <div class=" col-md-12">
                ...
                <br><button type="submit" class="btn btn-primary">Enviar</button> <button type="button" onclick="window.location.href = '<?= site_url($this->uri->segment(1)) ?>'" class="btn btn-danger">Cancelar</button>
            </div>
            </form>
        </div><!-- /.box-body -->
