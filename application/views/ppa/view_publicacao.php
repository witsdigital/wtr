    ...
    <section class="content-header">
        <h1>
            <?php foreach ($ppa as $row) { ?>
                ...
                ?>  
                Código
                <small>#<?php echo substr($row->id_ppa, -11, 11); ?></small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="invoice"> 
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <?php } ?>
                    <small class="pull-right"><?php echo $row->ano; ?></small>
                </h2>
            </div><!-- /.col -->
        </div>
        <!-- info row -->
        ...
        <div class="row no-print" style="float: right;">            <div class="col-xs-12">                <a href="<?php echo $row->file ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Ver arquivo</a>                <a href="<?= site_url('ppa') ?>" class="btn btn-primary"><i class="fa "></i> voltar</a>            </div>        </div>
        </div><!-- /.row -->
