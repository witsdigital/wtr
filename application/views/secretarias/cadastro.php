...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form action="<?= site_url(); ?>secretarias/salvar"  onsubmit="return validarSenha(this)" enctype="multipart/form-data" method="post">
                    <div class="col-md-12">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-7">
                                ...
                                <input type="text" name="secretario"  class="form-control"  required placeholder="">
                            </div>
