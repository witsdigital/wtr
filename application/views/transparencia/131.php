...
<script>
    ...
    function confirma(id) {
        ...
        window.open('<?= site_url() ?>portal/recdespview/' + id);
                        ...
                        <div class="col-md-3">
                            ...
                            <table style=" width:100%;" height="96" border="0" cellpadding="20" >
                                <tr>
                                    <td >
                                        <div align="center">
                                            <a href="<?= site_url() . 'portal/recdespview/' . $row->mes_competencia ?>"><img class="imgcalendar" src="<?= base_url() ?>assets/images/calendario_publica.png" /></a>
                                        </div>
