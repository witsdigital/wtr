...
<form id="frm" name="frm" action="<?= site_url(); ?>transparencia/filtrardespesa"  enctype="multipart/form-data" method="post">
               <div  class="row" >
            ...
            <option value="LIQ">Liquidação</option>
            <option value="PAG">Pagamento</option>
                      ...
                      <div class="col-md-12">
						<label for="data">Credor:</label>
						
              <select name="credor" class="form-control selectpicker" data-show-subtext="true" data-live-search="true">
              <option  selected value="0">Todos</option>
              <?php 
            foreach($query as $row){ ?>
             
              <option data-subtext="Sen California" value="<?= $row->credor?>"><?= $row->credor?></option>
