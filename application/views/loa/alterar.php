...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-body">
                <form action="<?= site_url(); ?>loa/update"  onsubmit="return validarSenha(this)" enctype="multipart/form-data" method="post">
                    <div class="col-md-12">
                        
                        <div class="box-body">
                            <div class="form-group col-md-7">
                                <label for="exampleInputEmail1">Descricao</label>
                                <input type="hidden" value="<?php echo $loa[0]->id_loa; ?>" name="iduser">
                                <input type="text" name="descricao" value="<?php echo $loa[0]->descricao?>"  class="form-control" required placeholder="nome">
                            </div>
                           
                            <div class="form-group col-md-7">
                                <label for="exampleInputEmail1">Ano</label>
                                <input type="tel" name="ano" value="<?php echo $loa[0]->ano?>"  class="form-control" required placeholder="email">
                            </div>
                    ...
                    <div class=" col-md-12">
                        <br><button type="submit" class="btn btn-primary">Salvar</button> <button type="button" onclick="window.location.href='<?=  site_url('loa')?>'" class="btn btn-danger">Cancelar</button>
                    </div>
                </form>
            </div><!-- /.box-body -->
