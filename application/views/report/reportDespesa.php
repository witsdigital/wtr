 ...
 <br>
  ...
  $count = 0;
   foreach ($itens as $row) { 
    ...
    <td  style="border-top:1px solid black; width: 10%;  font-size:12px;"><?= $row->data_mov?></td>
      <td  style="border-top:1px solid black;  width: 80%; font-size:12px;"><?= $row->bem_servico?></td>
    
     
      <td  style="border-top:1px solid black; width: 10%;   font-size:11px;"><?= $row->tipo?></td>
      <td  style="border-top:1px solid black; width: 10%;   font-size:12px;">R$ <?= $row->valor?></td>
