                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLongTitle">Origem:  <?php echo $row->descricao ?></h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p><b>Competência: </b>  <?php echo $row->competencia ?></p>
                                        <p><b>Data Registro: </b>  <?php echo $row->data_registro ?></p>
