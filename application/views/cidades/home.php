    ...
    <div class="carousel  slide  js-jumbotron-slider" id="headerCarousel" data-interval="5000">
        ...
        <div class="carousel-inner">
            ...
            foreach ($slides as $rowsl) {
                ...
                ?>  ">
                    <img src="<?= base_url() ?>uploads/slides/7/<?php echo $rowsl->img ?>"	alt="The Best Construction HTML Theme" />
                    <!--                    <div class="container">
                                            <div class="carousel-content">
                                                <div class="jumbotron__category">
                                                    <h6><?php echo $rowsl->categoria ?></h6>
                                                </div>
                                                <div class="jumbotron__title">
                                                    <h1><?php echo $rowsl->titulo ?> </h1>
                                                </div>
                                                <div class="jumbotron__content">
                                                    <p>O Governo investe   de 30 milhoes em vacinas por todo o brasil</p>
...
<div  style="background-color:#ffffff" class="master-container">
    ...
    <div id="menu1" class="container " role="main">
        <div class="row">
            <?php
                    ...
                    <div class="row">
                        <?php foreach ($vereadores as $row) { ?>
                            <div class="col-sm-2 col-sm-3">
                                <a href="<?php echo base_url('portal/perfil') . '/' . $row->id ?>">
                                    <img src="<?= base_url() ?>uploads/funcionarios/<?php
                                    if ($row->img == "") {
                                        $img = "default.png";
                                    } else {
                                        $img = $row->img;
                                    } echo '7' . "/" . $img;
                                    ?> " alt="Client" width="210" height="210">
                                </a>
