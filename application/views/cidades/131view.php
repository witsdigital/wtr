                    ...
                    foreach ($data as $row) {
                        ...
                        <table style=" width:100%;" height="96" border="0" cellpadding="20" >
                            <tr>
                                ...
                                <td width="194"><div class="meta"> <span><strong><i class="icon-user"></i>Tipo:</strong> <br><a href="#"><?php echo $row->arquivo ?></a></span>
                                    </div></td>


                                <td width="76"><a href="<?= base_url() . 'portal/visualizar/' . $row->id . '/' . $row->arquivo ?>"><button type="buttom" class="btn btn-success"  >Consultar</button></a></td>
                            <hr />
                            </tr>
                        </table>
                    <?php }
