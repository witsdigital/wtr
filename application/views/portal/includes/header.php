...
<head>
 ...
 <title><?= $query[0]->entidade ?> </title>
            <meta property="og:image" content="http://governodeguajeru.ba.gov.br/assets/images/social.jpg">
            <meta property="og:title" content="<?= $query[0]->entidade ?>">
            <meta property="og:description" content="Portal de notícias e informação ao cidadão sobre o poder executivo de Guajeru">
...
.entry__article figure {
  ...
  <header class="sidenav" id="sidenav">
    ...
    <nav class="sidenav__menu-container">
      <ul class="sidenav__menu" role="menubar">
        ...
        <li>
         ...
         <li>
          <a href="#" class="sidenav__menu-link">Notícias</a>
        ...
        <li>
          <a href="<?= base_url('portal/transparencia') ?>" class="sidenav__menu-link sidenav__menu-link-category sidenav__menu-link--salad" target="_blank">Transparência</a>
        </li>
    ...
    <div class="socials sidenav__socials"> 
      <a class="social social-facebook" href="https://www.facebook.com/governodeguajeru/" target="_blank" aria-label="facebook">
            ...
            <nav class="flex-child nav__wrap d-none d-lg-block">              
              <ul class="nav__menu">
                ...
                <li class="nav__dropdown">
                  <a href="<?=  base_url('portal/noticias')?>">Notícias</a>
                ...
                <li class="nav__dropdown">
                  <a href="http://governodeguajeru.ba.gov.br/transparencia">Transparência</a>
    ...
    <div class="header">
      <div class="container">
        <div class="flex-parent align-items-center">
          ...
          <!-- Logo -->
          <a href="<?= base_url()?>" class="logo d-none d-lg-block">
            <img  class="logo__img" src="<?=  base_url()?>uploads/slides/7/<?php echo $logo[0]->img; ?>" alt="logo">
          </a>

          <!-- Ad Banner 728 -->
          <div class="text-center">
            <a href="#">
              <img src="<?=  base_url()?>uploads/slides/7/<?php echo $banner_1[0]->img; ?>" alt="">
            </a>
          </div>
