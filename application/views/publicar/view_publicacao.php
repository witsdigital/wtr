    ...
    <section class="content-header">
        <h1>
            <?php foreach ($publicacao as $row) { ?>
                ...
                ?>  
                Código
                <small>#<?php echo substr($row->id, -11, 11); ?></small>
            </h1>
            <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-xs-12 table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                        $query = $this->db->get_where('upload_arquivo_publicado', array('key' => $row->id));
                        $dados = $query->result();
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <!--<a href="<?= site_url('publicar/print_publicacao') ?>/<?php echo $row->id ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Imprimir</a>-->
                <a href="<?= site_url('publicar') ?>" class="btn btn-primary"><i class="fa "></i> voltar</a>
