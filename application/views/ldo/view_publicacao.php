    ...
    <section class="content-header">
        <h1>
            <?php foreach ($ldo as $row) { ?>
                ...
                ?>  
                Código
                <small>#<?php echo substr($row->id_ldo, -11, 11); ?></small>
            </h1>
            <ol class="breadcrumb">
        ...
        <div class="row no-print" style="float: right;">
            <div class="col-xs-12">
                <a href="<?= site_url() ?>/<?php echo $row->file ?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Ver arquivo</a>
                <a href="<?= site_url('ldo') ?>" class="btn btn-primary"><i class="fa "></i> voltar</a>
